...
async def evaluate_relevance_completeness(response: str, query: str) -> Tuple[int, int, str]:
    ...
    judge_response, _ = await generate_response(prompt)
...
async def evaluate_hallucination(response: str, contexts: List[str]) -> Tuple[int, List[str], str]:
